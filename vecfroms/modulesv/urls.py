...
from .views import ModulesPageView, ModulesPageView1, ModulesPageView2, ModulesPageView3, CreateComment1,CreateComment2, CreateComment3 ,LayerModel1,LayerModel2,LayerModel3,ModulesPageView11,ModulesPageView12

urlpatterns = [
    path('', ModulesPageView.as_view(), name="modules"),
    path('1', ModulesPageView1.as_view(), name="modules1"),
    path('11', ModulesPageView11.as_view(), name="modules11"),
    path('12', ModulesPageView12.as_view(), name="modules12"),
